<?php
namespace Hadil\Jobs\Block\Adminhtml\Job\Edit;
...
class Form extends Generic
{
     ...
     * @param \Hadil\Jobs\Model\Source\Job\Status $status
     * @param \Hadil\Jobs\Model\Source\Department $department
     * @param array $data
     */
    public function __construct(
        ...
        \Hadil\Jobs\Model\Source\Job\Status $status,
        \Hadil\Jobs\Model\Source\Department $department,
        array $data = []
    ) {
    ...
    {
        /** @var \Hadil\Jobs\Model\Job $model */
        $model = $this->_coreRegistry->registry('jobs_job');

        /** @var \Hadil\Framework\Data\Form $form */
