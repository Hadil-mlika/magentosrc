<?php
namespace Hadil\Jobs\Controller\Adminhtml\Job;
...
class Edit extends Action
{
     ...
     * @param \Hadil\Jobs\Model\Job $model
     */
    public function __construct(
        Action\Context $context,
        \Magento\Framework\View\Result\PageFactory $resultPageFactory,
        \Magento\Framework\Registry $registry,
        \Hadil\Jobs\Model\Job $model
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Hadil_Jobs::job_save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Hadil_Jobs::job')
